...
def gen_keys_by_name(key="", key_path_dir="", name=""):
    ...
    os.chown(key_path_dir, get_name_id.pw_uid, get_name_id.pw_gid)
    os.chown(public_key, get_name_id.pw_uid, get_name_id.pw_gid)
    os.chown(private_key, get_name_id.pw_uid, get_name_id.pw_gid)
    os.chown(config_file, get_name_id.pw_uid, get_name_id.pw_gid)
