...
class Asset(models.Model):
    ...
    group = models.ManyToManyField(AssetGroup, blank=True, verbose_name=u"所属部门")
    ...
    service = models.ManyToManyField(AssetService, blank=True, null=True, verbose_name=u"具体服务")
    ...
    parent_ip = models.CharField(max_length=16, blank=True, null=True, verbose_name=u'宿主机IP')
    ...
    manager = models.CharField(max_length=64, blank=True, null=True, verbose_name=u"管理员")
